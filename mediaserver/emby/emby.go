...
func (e *APIError) Error() string {
	if e.Message != "" {
		return fmt.Sprintf("emby: HTTP %d: %s", e.StatusCode, e.Message)
	}
	if e.RawBody != "" {
		return fmt.Sprintf("emby: HTTP %d: %s", e.StatusCode, e.RawBody)
	}
...
func (c *Client) doRequest(ctx context.Context, method, path string, body, dst any) error {
	...
	if err != nil {
		return fmt.Errorf("emby: parse URL: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("emby: create request: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("emby: %s %s: %w", method, path, err)
	}
	defer func() { _ = resp.Body.Close() }()

	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return fmt.Errorf("emby: read response: %w", err)
	}
...
func (c *Client) get(ctx context.Context, path string, params url.Values) ([]byte, error) {
	...
	u, err := url.Parse(c.rawBaseURL + path)
	if err != nil {
		return nil, fmt.Errorf("emby: parse URL: %w", err)
	}

	req, err := http.NewRequestWithContext(ctx, http.MethodGet, u.String(), http.NoBody)
	if err != nil {
		return nil, fmt.Errorf("emby: create request: %w", err)
	}
	...
	resp, err := c.httpClient.Do(req)
	if err != nil {
		return nil, fmt.Errorf("emby: GET %s: %w", path, err)
	}
	defer func() { _ = resp.Body.Close() }()

	body, err := io.ReadAll(resp.Body)
	if err != nil {
		return nil, fmt.Errorf("emby: read response: %w", err)
	}
...
func (c *Client) AuthenticateByName(ctx context.Context, username, password string) error {
	...
	err := c.doRequest(ctx, http.MethodPost, "/emby/Users/AuthenticateByName", &authRequest{
		Username: username,
		Pw:       password,
	}, &result)
	if err != nil {
...
func (c *Client) GetPublicSystemInfo(ctx context.Context) (*PublicSystemInfo, error) {
	data, err := c.get(ctx, "/emby/System/Info/Public", nil)
	if err != nil {
		return nil, err
	}
	var info PublicSystemInfo
	if err := json.Unmarshal(data, &info); err != nil {
		return nil, fmt.Errorf("emby: decode public info: %w", err)
	}
	return &info, nil
}
...
func (c *Client) GetSystemInfo(ctx context.Context) (*SystemInfo, error) {
	data, err := c.get(ctx, "/emby/System/Info", nil)
	if err != nil {
		return nil, err
	}
	var info SystemInfo
	if err := json.Unmarshal(data, &info); err != nil {
		return nil, fmt.Errorf("emby: decode system info: %w", err)
	}
	return &info, nil
}
...
func (c *Client) Ping(ctx context.Context) error {
	_, err := c.get(ctx, "/emby/System/Ping", nil)
	return err
}
...
func (c *Client) GetUsers(ctx context.Context) ([]UserDto, error) {
	data, err := c.get(ctx, "/emby/Users", nil)
	if err != nil {
		return nil, err
	}
	var users []UserDto
	if err := json.Unmarshal(data, &users); err != nil {
		return nil, fmt.Errorf("emby: decode users: %w", err)
	}
	return users, nil
}
...
func (c *Client) GetCurrentUser(ctx context.Context) (*UserDto, error) {
	data, err := c.get(ctx, "/emby/Users/Me", nil)
	if err != nil {
		return nil, err
	}
	var user UserDto
	if err := json.Unmarshal(data, &user); err != nil {
		return nil, fmt.Errorf("emby: decode user: %w", err)
	}
	return &user, nil
}
...
func (c *Client) GetSessions(ctx context.Context) ([]SessionInfoDto, error) {
	data, err := c.get(ctx, "/emby/Sessions", nil)
	if err != nil {
		return nil, err
	}
	var sessions []SessionInfoDto
	if err := json.Unmarshal(data, &sessions); err != nil {
		return nil, fmt.Errorf("emby: decode sessions: %w", err)
	}
	return sessions, nil
}
...
func (c *Client) GetItems(ctx context.Context, params url.Values) (*ItemsResult, error) {
	...
	data, err := c.get(ctx, "/emby/Items", params)
	if err != nil {
		return nil, err
	}
	var result ItemsResult
	if err := json.Unmarshal(data, &result); err != nil {
		return nil, fmt.Errorf("emby: decode items: %w", err)
	}
	return &result, nil
}
...
func (c *Client) GetItem(ctx context.Context, itemID string) (*BaseItemDto, error) {
	data, err := c.get(ctx, "/emby/Items/"+url.PathEscape(itemID), nil)
	if err != nil {
		return nil, err
	}
	var item BaseItemDto
	if err := json.Unmarshal(data, &item); err != nil {
		return nil, fmt.Errorf("emby: decode item: %w", err)
	}
	return &item, nil
}
...
func (c *Client) GetUserViews(ctx context.Context, userID string) (*ItemsResult, error) {
	data, err := c.get(ctx, "/emby/UserViews", url.Values{"userId": {userID}})
	if err != nil {
		return nil, err
	}
	var result ItemsResult
	if err := json.Unmarshal(data, &result); err != nil {
		return nil, fmt.Errorf("emby: decode views: %w", err)
	}
	return &result, nil
}
